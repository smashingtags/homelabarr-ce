![Image of HomelabARR CLI](/img/container_images/docker-restic.png)
...
#### Install Container
Install from homelabarr-cli>apps>backup menu
...
**Option 2: Network Share via RClone**
Create `/opt/appdata/restic/rclone/rclone.conf` for network storage:
```ini
[nas-backup]
type = local
```
