![Image of HomelabARR CLI](/img/container_images/docker-duplicati.png)
...
[Duplicati](https://www.duplicati.com/) provides comprehensive backup solutions optimized for local NAS environments. It supports standard protocols like FTP, SSH, WebDAV, and integrates seamlessly with local storage systems including UnRAID shares, TrueNAS datasets, and network attached storage via SMB/NFS.
