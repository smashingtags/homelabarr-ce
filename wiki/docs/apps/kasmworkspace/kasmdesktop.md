...
Kasm Desktop Provides Ubuntu Desktop with all available applications from KASM included. Individual apps are also available via HomelabARR CE Menu under `kasmworkspaces`.
...
Install via HomelabARR CE Menu
