# HomelabARR CE Local Mode v1.0 - Release Notes

## 🎉 New Feature: Local Mode Deployment

HomelabARR CE now supports **Local Mode** - a simplified deployment option that provides direct IP:PORT access to services without requiring Traefik reverse proxy, Authelia authentication, or Cloudflare configuration.

## 🚀 One-Line Installation

Get HomelabARR CE Local Mode running instantly:
...
**In addition to the curated templates, HomelabARR CE Local Mode includes 171+ pre-converted applications covering every category:**
...
sudo ./install.sh
```
*This launches the original HomelabARR CE installer with:*
...
**Compatibility**: HomelabARR CE Master Branch
