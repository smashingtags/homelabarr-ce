...
cd ~ && sudo rm -rf homelabarr-ce 2>/dev/null; \
git clone https://github.com/smashingtags/homelabarr-ce.git && \
cd homelabarr && chmod +x install-local.sh && ./install-local.sh
...
services:
  [service-name]:
    ...
    container_name: homelabarr-[service]
...
# View container logs
docker logs homelabarr-[container-name] --tail 50
...
```bash
# Recreate network
docker network rm homelabarr-local
...
|----------|---------|------|
| **GitHub Issues** | Bug reports & feature requests | [GitHub Repository](https://github.com/smashingtags/homelabarr-ce/issues) |
| **Discord Community** | Real-time support & discussion | [Discord Server](https://discord.gg/Pc7mXX786x) |
| **Wiki Documentation** | Comprehensive guides & tutorials | [Documentation](https://github.com/smashingtags/homelabarr-ce/wiki) |
| **Reddit Community** | Community discussions & tips | r/HomelabARR |
...
If HomelabARR CE's professional deployment capabilities have enhanced your infrastructure:

**☕ [Support on Ko-fi](https://ko-fi.com/homelabarr)** - Help us continue improving containerization standards, documentation, and deployment automation!
