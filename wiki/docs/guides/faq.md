...
### What is HomelabARR CLI?
HomelabARR CLI is a comprehensive Docker-based media server stack that provides automated deployment and management of 162+ self-hosted applications including Plex, Radarr, Sonarr, and many others.

### What happened to HomelabARR CLI?
HomelabARR CLI has been rebranded to HomelabARR CLI as part of a major restructuring effort. All functionality remains the same, but with improved documentation, better organization, and modernized tooling.

### Is this free to use?
Yes! HomelabARR CLI is completely free and open-source under the MIT license. There are no premium features or paid tiers.
...
Currently, HomelabARR CLI is designed for Linux systems only. Windows and macOS support may be added in the future.
...
tar -czf config-backup-$(date +%Y%m%d).tar.gz homelabarr-cli/
```
...
No, never expose Docker daemon to the internet. HomelabARR CLI doesn't require this.

## Update Questions

### How do I update HomelabARR CLI?
```bash
# Update repository
cd homelabarr-cli
...
2. **GitHub Issues**: [https://github.com/smashingtags/homelabarr-cli/issues](https://github.com/smashingtags/homelabarr-cli/issues)
...
If this FAQ helped you solve your issue, consider supporting HomelabARR CLI development:
