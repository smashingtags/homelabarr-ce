...
HomelabARR Mobile is an optional companion app for iOS and Android. It connects to your existing CE server — same dashboard, same 3,000+ apps, same login — but native on your phone.
...
![HomelabARR Mobile — connected to CE server showing 3,000+ apps, category tabs, and Deploy buttons](../img/screenshots/mobile-connected.png){ width="300" }

## What It Does

- **Browse and deploy** all 3,000+ container templates from your phone
...
Browse all 3,000+ apps (deploys are disabled on the demo server).
