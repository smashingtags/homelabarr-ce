# HomelabARR CLI - Architecture Documentation

## System Overview

HomelabARR CLI is a containerized media server stack built on Docker with two distinct deployment architectures designed for different use cases.
...
### HomelabARR CLI to HomelabARR CLI
```
...
```
Current: smashingtags/homelabarr-cli
Future:  homelabarr/*
  ├── homelabarr/cli
