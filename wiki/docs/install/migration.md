...
HomelabARR CLI has transitioned from cloud-dependent to local NAS-focused architecture. This guide helps you migrate from PGBlitz or other cloud-based systems to a modern, local storage solution.
...
3. Return here once HomelabARR CLI is installed
...
Deploy the mount system through HomelabARR CLI CLI under System section.

## 5. Restore Applications

After configuring local storage:

1. Install applications through HomelabARR CLI CLI
