...
HomelabARR CLI is a comprehensive Docker-based media server stack that provides automated deployment and management of 100+ self-hosted applications including Plex, Radarr, Sonarr, and more.
...
1. **HomelabARR CLI - Traefik + Authelia** (run this first)
   - Sets up reverse proxy and authentication
   - Configures SSL certificates
   - Prepares infrastructure

2. **HomelabARR CLI - Applications** (run after Traefik)
