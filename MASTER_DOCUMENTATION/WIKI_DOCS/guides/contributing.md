# Contributing to HomelabARR CLI

We welcome contributions from the community! This guide will help you get started with contributing to HomelabARR CLI.

## Ways to Contribute

### 1. 🐛 Bug Reports
- Report issues through [GitHub Issues](https://github.com/smashingtags/homelabarr-cli/issues)
...
git clone https://github.com/YOUR_USERNAME/homelabarr-cli.git
cd homelabarr-cli

# Add upstream remote
git remote add upstream https://github.com/smashingtags/homelabarr-cli.git
```
...
Beyond code contributions, you can support HomelabARR CLI development:
...
**Thank you for contributing to HomelabARR CLI!**
