# 🎉 HomelabARR CLI v1.5.0 - GHCR Migration & Container Optimization

## 🚀 **Major Release Highlights**

This release represents the **largest infrastructure upgrade** in HomelabARR CLI history, with complete migration to GitHub Container Registry and comprehensive container optimization.
...
- **Documentation**: [https://smashingtags.github.io/homelabarr-cli](https://smashingtags.github.io/homelabarr-cli)
...
**Compatibility**: HomelabARR CLI 1.4.x → 1.5.0  
