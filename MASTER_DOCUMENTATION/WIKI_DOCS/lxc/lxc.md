...
## How to install HomelabARR CLI on a Proxmox LXC container

This guide will take you through how to prepare Proxmox to install HomelabARR CLI on an LXC.
...
1. Create a new LXC container:
   ...
   1. **Root Disk** tab:
      1. Set the disk size high enough to handle all HomelabARR CLI apps. Allow room for expansion. I personally have this set to 500Gb.
   1. **CPU** tab:
...
Now your LXC is ready to continue the install of HomelabARR CLI
