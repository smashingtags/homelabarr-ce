# HomelabARR CLI Applications

![Image of HomelabARR CLI](/img/container_images/docker-homelabarr-cli.png)

HomelabARR CLI supports 100+ self-hosted applications across multiple categories. Applications can be deployed in two modes:

## Deployment Modes

### 🌐 Full Mode (Default)
- Deploy through HomelabARR CLI interface: `sudo homelabarr -i`
- Traefik reverse proxy with automatic SSL
- Authelia multi-factor authentication
- Domain-based access (e.g., `https://plex.yourdomain.com`)
- Complete integration with all HomelabARR CLI features
