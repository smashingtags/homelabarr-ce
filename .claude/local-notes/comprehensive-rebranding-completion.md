...
ghcr.io/homelabarr/ → ghcr.io/homelabarr/ (kept for functionality)
...
- **Temporary Preservation**: Kept ghcr.io/homelabarr/ references to maintain functionality
...
2. **Update References**: Switch from ghcr.io/homelabarr/ to ghcr.io/smashingtags/
