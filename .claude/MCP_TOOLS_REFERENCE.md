...
#### Jira Tools (Project: HL, Instance: mjashley.atlassian.net)
...
- Assignee: Use email "michael@mjashley.com"
...
fields={"assignee": "michael@mjashley.com"}  # ✅
...
## Support Links
- Jira: https://mjashley.atlassian.net
- Confluence: https://mjashley.atlassian.net/wiki/spaces/DO
