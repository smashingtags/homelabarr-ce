...
Only changes ghcr.io/smashingtags/ back to ghcr.io/homelabarr/ 
...
def revert_registry_only():
    ...
    registry_replacement = 'ghcr.io/homelabarr/'
    
    files_changed = 0
    total_replacements = 0
    
    print("Reverting Docker registry to homelabarr (temporarily)...")
