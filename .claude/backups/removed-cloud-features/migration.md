...
Even though PGblitz still works, **there are numerous upsides in shifting to homelabarr-cli:**
...
We strongly recommend restoring your Server on a [VPS](https://www.hetzner.com/cloud "VPS") or something similar before making the final migration. This is to avoid data-loss and to harden your backups for your final homelabarr-cli migration. This guide will take you through a migration with Teamdrive deployed on your pg installation. Feel free to experiement with the gdsa builder in the CLI.
...
```
sudo wget -qO- https://raw.githubusercontent.com/homelabarr-cli/HomelabarrCli/master/backup.sh | sudo bash
```
...
Now, please order a VPS with ubuntu 22 on it and follow the instructions on the [Wiki](https://homelabarr-cli.github.io/homelabarr-cli/install/install.html). When homelabarr-cli is installed on your host, return here and follow instructions
...
After this you are ready to restore your PG apps on a brand new homelabarr-cli installation
