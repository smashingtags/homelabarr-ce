...
Latest yml for installation can be found here [Link](https://github.com/smashingtags/homelabarr-cli/apps/blob/master/mount/docker-compose.yml).
...
#### Setup:
- Create new Service Account Keys (see [Documentation](https://homelabarr-cli.github.io/homelabarr-cli/drive/saccounts.html))
...
## Support
Kindly report any issues on [GitHub](https://github.com/smashingtags/homelabarr-cli/issues) or [![Discord: https://discord.gg/Pc7mXX786x](https://img.shields.io/badge/Discord-gray.svg?style=for-the-badge)](https://discord.gg/Pc7mXX786x)
