...
## kometa
KOMETA_TIME=${KOMETA_TIME:-06:00}
KOMETA_COLLECTIONS_ONLY=${KOMETA_COLLECTIONS_ONLY:-false}
KOMETA_LIBRARIES_ONLY=${KOMETA_LIBRARIES_ONLY:-false}
KOMETA_NO_MISSING=${KOMETA_NO_MISSING:-false}
