...
confluence_url: "https://your-instance.atlassian.net/wiki/spaces/DO/pages/6815871"
confluence_space: "DO"
category: "General"
created_date: ""
updated_date: ""
...
### Act III: The HomelabARR Fork (2020-2021)

**Enter Ricardo (REMOVED_USER/MrDoob)**- A skilled developer who initially tried to stabilize PlexGuide. As documented in the Discord logs: - Became frustrated with Admin's constant breaking updates - Did "heavy lifting" working 24/7 on fixes - Eventually earned "admin 2.0 rank" for destructive behavior

The breaking point came when REMOVED_USER:
> 
...
HomelabARR launched as REMOVED_USER's fork, featuring: - Docker-first architecture - UnionFS/mount-enhanced for cloud storage - Improved container management

**cyb3rgh05t's Contributions**: As a HomelabARR contributor, cyb3rgh05t created several auxiliary tools including plex-tautulli-dashboard and discord-plex-bot.
...
- **REMOVED_USER/MrDoob**- Brilliant coder whose destructive exit taught us about trust
- **cyb3rgh05t**- HomelabARR contributor whose work we acknowledge but don't depend upon
...
- PGBlitz → PlexGuide → HomelabARR → MHA/PTS → HomelabARR
