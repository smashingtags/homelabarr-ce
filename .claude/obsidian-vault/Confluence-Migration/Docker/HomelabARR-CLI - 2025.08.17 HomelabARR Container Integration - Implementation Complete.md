...
confluence_url: "https://your-instance.atlassian.net/wiki/spaces/DO/pages/4522100"
confluence_space: "DO"
category: "Docker"
created_date: ""
updated_date: ""
...
Completed comprehensive update from legacy homelabarr references:
#### Files Updated:

- **Dockerfile.backend**: Mount points`/homelabarr`→`/homelabarr-cli`
- **homelabarr.yml**: CLI bridge paths and deployment examples
- **GitHub Actions**: Deployment documentation
- **cli-bridge.js**: Path resolution`../../../homelabarr`→`../../../homelabarr-cli`
...
- **homelabarr-cli**: Core infrastructure (formerly homelabarr)
