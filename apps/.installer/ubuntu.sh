...
interface() {
buildshow=$(ls -1p /opt/homelabarr/apps/ | grep '/$' | $(command -v sed) 's/\/$//')
printf "
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
"
  ...
  if [[ $section == "" ]];then clear && interface;fi
     checksection=$(ls -1p /opt/homelabarr/apps/ | grep '/$' | $(command -v sed) 's/\/$//' | grep -x $section)
...
restorebackup=null
section=${section}
buildshow=$(ls -1p /opt/homelabarr/apps/${section}/ | sed -e 's/.yml//g' )
printf "
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
"
  ...
  if [[ $typed == "" ]];then clear && install;fi
     buildapp=$(ls -1p /opt/homelabarr/apps/${section}/ | $(command -v sed) -e 's/.yml//g' | grep -x $typed)
...
OPTIONSTAR="--warning=no-file-changed \
  --ignore-failed-read \
  --absolute-names \
  --exclude-from=/opt/homelabarr/apps/.backup/backup_excludes \
