...
class ConfluenceToObsidian:
    ...
    def extract_page_info(self, html_content, filename):
        ...
        confluence_url = f"https://your-instance.atlassian.net/wiki/spaces/DO/pages/{page_id}" if page_id else ""
    ...
    def html_to_markdown(self, html_elem):
        ...
        for elem in html_elem.descendants:
            if elem.name == 'h1':
                ...
                if 'your-instance.atlassian.net' in link_url:
...
Original URL: `https://your-instance.atlassian.net/wiki/spaces/DO/`
