...
sudo wget -qO- https://raw.githubusercontent.com/HomelabarrCli/HomelabarrCli/master/scripts/security/badips.sh | sudo bash -v
sudo wget -O /opt/appdata/traefik/bann.sh https://raw.githubusercontent.com/HomelabarrCli/HomelabarrCli/master/scripts/security/traefik-bann.sh
...
printf "${RED}homelabarr-cli.github.io Security Patch\n${NC} code @ doob1987\n"
