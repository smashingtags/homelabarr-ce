...
export const APP_ICON_MAP: Record<string, LucideIcon> = {
  ...
  'bazarr4k': FileText,
  'prowlarr': SearchIcon,
  'prowlarr4k': SearchIcon,
  'prowlarrhdr': SearchIcon,
  'tautulli': BarChart2,
  'kometa': Library,
  'traktarr': Tv2,
  'traktarr4k': Tv2,
  ...
  'pihole': Shield,
  'pihole-cloudflared': Shield,
  'pihole-unbound': Shield,
  'recipes': Book,
  'snapdrop': Files,
  'teamspeak': MessageSquare,
  'unbound': Network,
  'unifi-controller': Wifi,
  'webgrabplus': DownloadIcon,
  'webtop': Monitor,
  'wg-easy': Shield,
  'wg-manager': Shield,
  'whoogle': SearchIcon,
